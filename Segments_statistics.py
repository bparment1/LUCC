...
j=0  #j is the index used to keep track of the number of random images 
...
for j in range(1,nb_images+1,1):
    ...
    for i in range(1,nb_files+1,1):
            ...
            parameters = wd1+inputf3+'.rst'+'*'+wd1+idrisi_filename1+'.rst'+'*'+'1*'+stat_n2+'*'+wd1+inputf3+'_ID_'+output_prefix+'_'+str(j)+'_b_'+str(loop_number1)+'_SD.avl'
            module = 'extract'
            print('Running ' + module + ' module with parameters ' + parameters)
            success = api.RunModule(module, parameters, True, '', '', '', '', True)  #the output of api.runmodule is a value '1' if it is sucessful and '0' if not.
            if not success:
            ...
            parameters = wd1+inputf3+'.rst'+'*'+wd1+idrisi_filename1+'.rst'+'*'+'1*'+stat_n1+'*'+wd1+inputf3+'_ID_'+output_prefix+'_'+str(j)+'_b_'+str(loop_number1)+'_avg.avl'
            module = 'extract'
            print('Running ' + module + ' module with parameters ' + parameters)
            success = api.RunModule(module, parameters, True, '', '', '', '', True)  #the output of api.runmodule is a value '1' if it is sucessful and '0' if not.
            if not success:
            ...
            #RUN ASSIGN
            parameters = wd1+'ps_'+inputf3+'_PIXID'+'.rst'+'*'+wd1+'ps_'+inputf3+'_ID_'+output_prefix+'_'+str(j)+'_b_'+str(loop_number1)+'_SD.rst'+'*'+wd1+inputf3+'_ID_'+output_prefix+'_'+str(j)+'_b_'+str(loop_number1)+'_SD.avl'  
            module = 'assign'
            print('Running ' + module + ' module with parameters ' + parameters)
            success = api.RunModule(module, parameters, True, '', '', '', '', True)  #the output of api.runmodule is a value '1' if it is sucessful and '0' if not.
            if not success:
            ...
            #RUN ASSIGN
            parameters = wd1+'ps_'+inputf3+'_PIXID'+'.rst'+'*'+wd1+'ps_'+inputf3+'_ID_'+output_prefix+'_'+str(j)+'_b_'+str(loop_number1)+'_avg.rst'+'*'+wd1+inputf3+'_ID_'+output_prefix+'_'+str(j)+'_b_'+str(loop_number1)+'_avg.avl'  
            module = 'assign'
            print('Running ' + module + ' module with parameters ' + parameters)
            success = api.RunModule(module, parameters, True, '', '', '', '', True)  #the output of api.runmodule is a value '1' if it is sucessful and '0' if not.
            if not success:
    ...
    listfiles1_wd1 = glob.glob(wd1+'ps_'+inputf3+'_ID_'+output_prefix+'_'+str(j)+'_b_*_SD.rst')
    rgf_name_SD =wd1+'ps_'+inputf3+'_'+output_prefix+'_'+str(j)+'_'+str(nb_files)+'_SD.rgf'
